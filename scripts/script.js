...
function phoenix(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel4").style.opacity = "0.5";
    document.getElementById("sel5").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel5").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/phoenix.png)";
    document.getElementById("nombre").innerHTML = "//Phoenix";
    document.getElementById("biblio").innerHTML = "Proviene del Reino Unido. El poder estelar de Phoenix se manifiesta en su estilo de combate al incendiar el campo de batalla con sus granadas aturdidoras y cegadoras. Sin importar si cuenta con apoyo o no, participará en la batalla bajo sus propios términos.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/breeze.png)";
    document.getElementById("mapnombre").innerHTML = "Breeze";
}
...
function reyna(){
    ...
    document.getElementById("sel5").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel5").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/reyna.png)";
    document.getElementById("nombre").innerHTML = "//Reyna";
    document.getElementById("biblio").innerHTML = "Desde el corazón de México, Reyna llega para dominar los duelos uno contra uno y cada asesinato que realiza aumenta su poder. Su letalidad solo está limitada por tu destreza al usarla, por lo que su eficacia dependerá mucho de ello.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/ascent.png)";
    document.getElementById("mapnombre").innerHTML = "Ascent";
}
...
function jett(){
    ...
    document.getElementById("sel5").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel5").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/jett.png)";
    document.getElementById("nombre").innerHTML = "//Jett";
    document.getElementById("biblio").innerHTML = "Proviene de Corea del Sur. El ágil y evasivo estilo de pelea de Jett le permite enfrentarse a riesgos que otros no pueden. Es imparable en todos los enfrentamientos y acaba con sus enemigos antes de que sepan qué los atacó.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/haven.png)";
    document.getElementById("mapnombre").innerHTML = "Haven";
}
...
function yoru(){
    ...
    document.getElementById("sel5").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel5").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/yoru.png)";
    document.getElementById("nombre").innerHTML = "//Yoru";
    document.getElementById("biblio").innerHTML = "El nativo de Japón, Yoru, fractura la realidad para infiltrarse en las líneas enemigas sin ser visto. Con engaños y agresividad por igual, sorprende a sus objetivos antes de que sepan dónde buscarlo.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/icebox.png)";
    document.getElementById("mapnombre").innerHTML = "Icebox";
}
...
function raze(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel4").style.opacity = "0.5";
    document.getElementById("sel5").style.backgroundColor = "rgb(234,75,94)";
    document.getElementById("sel5").style.opacity = "1";
    document.getElementById("box2").style.backgroundImage = "url(../images/raze.png)";
    document.getElementById("nombre").innerHTML = "//Raze";
    document.getElementById("biblio").innerHTML = "Raze llega de Brasil con su explosiva personalidad y sus grandes armas. Gracias a su contundente estilo de juego, es muy buena para separar los enemigos atrincherados y para despejar espacios estrechos con una gran cantidad de explosiones.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/bind.png)";
    document.getElementById("mapnombre").innerHTML = "Bind";
}
...
function viper(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel4").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/viper.png)";
    document.getElementById("nombre").innerHTML = "//Viper";
    document.getElementById("biblio").innerHTML = "Química estadounidense, Viper despliega varios artefactos químicos venenosos para controlar el campo de batalla y afectar la visión de los enemigos. Si las toxinas no asesinan a su presa, sin duda lo harán sus juegos mentales.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/haven.png)";
    document.getElementById("mapnombre").innerHTML = "Haven";
}
...
function astra(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel4").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/astra.png)";
    document.getElementById("nombre").innerHTML = "//Astra";
    document.getElementById("biblio").innerHTML = "La agente ghanesa Astra canaliza las energías del cosmos para remodelar los campos de batalla a su antojo. Con pleno dominio de su forma astral y un talento para una profunda previsión estratégica, siempre está eones por delante del próximo movimiento de su enemigo.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/ascent.png)";
    document.getElementById("mapnombre").innerHTML = "ascent";
}
...
function brimstone(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel4").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/brimstone.png)";
    document.getElementById("nombre").innerHTML = "//Brimstone";
    document.getElementById("biblio").innerHTML = "Proveniente de Estados Unidos, Brimstone proporciona una constante ventaja para su equipo con su arsenal orbital. Su habilidad otorga información de forma precisa y a distancia, lo que lo hace un comandante sin igual en el campo.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/breeze.png)";
    document.getElementById("mapnombre").innerHTML = "breeze";
}
...
function omen(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(234,75,94)";
    document.getElementById("sel4").style.opacity = "1";
    document.getElementById("box2").style.backgroundImage = "url(../images/omen.png)";
    document.getElementById("nombre").innerHTML = "//Omen";
    document.getElementById("biblio").innerHTML = "Un espectro de la memoria, Omen caza entre las sombras, ciega a los enemigos, se transporta a través del campo de batalla y deja que la paranoia los invada mientras intentan descubrir dónde atacará.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/bind.png)";
    document.getElementById("mapnombre").innerHTML = "Bind";
}
...
function breach(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel4").style.opacity = "1";
    document.getElementById("box2").style.backgroundImage = "url(../images/breach.png)";
    document.getElementById("nombre").innerHTML = "//Breach";
    document.getElementById("biblio").innerHTML = "Breach, el sueco biónico, lanza poderosas ráfagas cinéticas para abrirse paso a la fuerza a través del territorio enemigo. El daño y la interrupción que inflige garantizarán que ninguna pelea sea justa.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/breeze.png)";
    document.getElementById("mapnombre").innerHTML = "Breeze";
}
...
function skye(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel4").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/skye.png)";
    document.getElementById("nombre").innerHTML = "//Skye";
    document.getElementById("biblio").innerHTML = "Procedentes de Australia, Skye y su manada de bestias se abren paso por territorio hostil. Con sus creaciones que obstaculizan al enemigo y su poder para sanar a los demás, los equipos serán más fuertes y seguros al lado de Skye.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/ascent.png)";
    document.getElementById("mapnombre").innerHTML = "Ascent";
}
...
function sova(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(55, 54, 63)";
    document.getElementById("sel4").style.opacity = "0.5";
    document.getElementById("box2").style.backgroundImage = "url(../images/sova.png)";
    document.getElementById("nombre").innerHTML = "//Sova";
    document.getElementById("biblio").innerHTML = "Proveniente de la tundra del eterno invierno de Rusia. Sova rastrea, encuentra y elimina a sus enemigos con gran eficiencia y precisión. Su arco personalizado y sus increíbles habilidades de exploración impedirán que sus enemigos puedan esconderse de él.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/icebox.png)";
    document.getElementById("mapnombre").innerHTML = "Icebox";
}
...
function kayo(){
    ...
    document.getElementById("sel4").style.backgroundColor = "rgb(234,75,94)";
    document.getElementById("sel4").style.opacity = "1";
    document.getElementById("box2").style.backgroundImage = "url(../images/kayo.png)";
    document.getElementById("nombre").innerHTML = "//KAY/O";
    document.getElementById("biblio").innerHTML = "KAY/O es una máquina de guerra creada con un solo propósito: neutralizar radiantes. Su poder para suprimir las habilidades enemigas neutraliza la capacidad de sus rivales para contraatacar, un aspecto que le da a él y a sus aliados la ventaja definitiva en la batalla.";
    document.getElementById("mapimg").style.backgroundImage = "url(../images/bind.png)";
    document.getElementById("mapnombre").innerHTML = "Bind";
}
